...
\begin{equation}
	...
	\qquad
	\sigma\left(\frac{\alpha_1}{\alpha_2}\right) = 0,018.
	\label{eqn:ergebnis1}
\end{equation}
...
\end{equation}
In \autoref{fig:plot1} sind die Messdaten grafisch dargestellt. Als Abweichung wurde für
die Winkel grundsätzlich mit $1^\circ$ gerechnet.
\begin{figure}[H]
	\centering
...
\end{equation}
Die für die Rechnung verwendeten Werte sind auch nochmals in \autoref{fig:plot2}
dargestellt. Wie im vorangegangenen Teil wurde auch hier mit einer Messungenauigkeit von
einem Grad gerechnet.
\begin{figure}[H]
	\centering
